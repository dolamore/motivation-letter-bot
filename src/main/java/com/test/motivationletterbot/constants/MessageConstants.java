...
public final class MessageConstants {
    ...
    public static final String FULLY_COMPLETED_MENU_MESSAGE = "You have provided all the possible information, now you can generate a motivational letter!\n\n";
    public static final String GREETING_MESSAGE = "Hello! I'm your motivation letter bot. I can help you create a motivation letter for a job application. Let's get started!";
}
